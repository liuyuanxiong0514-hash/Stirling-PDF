  ...
  return useMemo(() => {
    const allTools: ToolRegistry = {
      ...
      excelToolsHome: {
        ...
        name: t("excelToolsHome.title", "Excel Tools"),
        component: lazy(() => import("@app/tools/ExcelToolsHome")),
        description: t(
        ...
        supportedFormats: ["xlsx", "xls", "pdf", "png", "jpg"],
        endpoints: [],
        automationSettings: null,
        supportsAutomate: false,
        synonyms: ["excel", "spreadsheet", "xlsx", "table"],
      },
      tableExtractExcel: {
        icon: <TableChartRoundedIcon style={{ fontSize: "1.5rem" }} />,
      ...
      smartExtractExcel: {
        icon: <TableChartRoundedIcon style={{ fontSize: "1.5rem" }} />,
        name: t("home.smartExtractExcel.title", "Smart Extract & Regenerate"),
        component: lazy(() => import("@app/tools/SmartExtractExcel")),
        description: t(
          "home.smartExtractExcel.desc",
          "Upload Excel, keep fields, filter rows, group data, and regenerate a new Excel file",
        ),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.EXCEL_TOOLS,
        supportedFormats: ["xlsx", "xls"],
        endpoints: [
          "excel/smart-extract/preview",
          "excel/smart-extract/parse-requirement",
          "excel/smart-extract/ai-parse",
          "excel/smart-extract/generate",
        ],
        automationSettings: null,
        supportsAutomate: false,
        synonyms: ["excel", "extract", "filter", "spreadsheet", "xlsx"],
      },
      smartMergeExcel: {
        icon: <TableChartRoundedIcon style={{ fontSize: "1.5rem" }} />,
        name: t("home.smartMergeExcel.title", "Smart Table Merge"),
        component: lazy(() => import("@app/tools/SmartMergeExcel")),
        description: t(
          "home.smartMergeExcel.desc",
          "Upload multiple Excel files or sheets, use AI to map fields, and merge them into a new Excel file",
        ),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.EXCEL_TOOLS,
        supportedFormats: ["xlsx", "xls"],
        endpoints: ["excel/merge/upload", "excel/merge/ai-parse", "excel/merge/generate"],
        automationSettings: null,
        supportsAutomate: false,
        synonyms: ["excel", "merge", "join", "append", "spreadsheet", "xlsx"],
      },
      smartCleanExcel: {
        icon: <TableChartRoundedIcon style={{ fontSize: "1.5rem" }} />,
        name: t("home.smartCleanExcel.title", "Smart Data Clean"),
        component: lazy(() => import("@app/tools/SmartCleanExcel")),
        description: t(
          "home.smartCleanExcel.desc",
          "Upload Excel, detect data quality issues, use AI to create cleaning rules, and generate a cleaned workbook",
        ),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.EXCEL_TOOLS,
        supportedFormats: ["xlsx", "xls"],
        endpoints: ["excel/clean/analyze", "excel/clean/ai-parse", "excel/clean/generate"],
        automationSettings: null,
        supportsAutomate: false,
        synonyms: ["excel", "clean", "normalize", "deduplicate", "spreadsheet", "xlsx"],
      },
      imageInfoExtractExcel: {
        icon: <TableChartRoundedIcon style={{ fontSize: "1.5rem" }} />,
        name: t("home.imageInfoExtractExcel.title", "图片信息提取表格"),
        component: lazy(() => import("@app/tools/ImageInfoExtractExcel")),
        description: t(
          "home.imageInfoExtractExcel.desc",
          "Upload images, run OCR, structure the text with AI, and export the result to Excel",
        ),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.EXCEL_TOOLS,
        supportedFormats: ["png", "jpg", "jpeg", "webp"],
        endpoints: ["excel/image-info-extract"],
        automationSettings: null,
        supportsAutomate: false,
        synonyms: ["excel", "image", "ocr", "invoice", "receipt", "id card"],
      },
      changePermissions: {
